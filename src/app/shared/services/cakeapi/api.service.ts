...
import { AppModel } from '../../model/cakeapi/app.model';
...
export class APIService {
  ...
  createWithUpload(model: AppModel, qparams: any = null) {
    ...
    return this.http.post(this.BASE_URL + this.url, formData, { reportProgress, params, headers, observe: 'events' })
      .subscribe(
        (event) => {
  ...
  updateWithUpload(model: AppModel, qparams: any = null) {
    ...
    return this.http.post(this.BASE_URL + this.url + `/${model.id}`, formData, { reportProgress, params, headers, observe: 'events' })
      .subscribe(
        (event) => {
          this.handleUploadProgress(event, (res) => {
