...
export class NavService {
  ...
  portalMenuItems: BehaviorSubject<Menu[]>;
  organisationMenuItems: BehaviorSubject<Menu[]>;

  constructor(
    public translate: TranslateService
  ) {
    this.setupPortalNavMenu();
    this.setupOrgAdminMenuItems();
    this.onResize();
  ...
  setupPortalNavMenu() {
    ...
    this.portalMenuItems = new BehaviorSubject<Menu[]>(PORTAL_MENUITEMS);
  }

  setupOrgAdminMenuItems() {
    // Member Portal Items
    const ORGANISATION_MENUITEMS: Menu[] = [
      {
    ...
    this.organisationMenuItems = new BehaviorSubject<Menu[]>(ORGANISATION_MENUITEMS);
  }
}
